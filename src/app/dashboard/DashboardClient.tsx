...
export default function DashboardClient({
  ...
  // Visual "I clicked, something is happening" states.
  ...
  const navLocked = creating || loggingOut || importing;
  ...
  async function createDoc() {
    ...
    // creating stays true until unmount during nav
  }
        ...
        <div className="mx-auto max-w-5xl px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 text-sm">
            ...
            <button
              onClick={logout}
              disabled={navLocked}
              className="text-muted hover:text-foreground underline-offset-2 hover:underline disabled:opacity-60 disabled:cursor-progress inline-flex items-center gap-1"
            >
              {loggingOut && (
                <span
        ...
        <div className="flex items-center justify-between mb-6 gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={createDoc}
              disabled={navLocked}
              className="rounded-md bg-foreground text-background px-3 py-2 text-sm font-medium hover:opacity-90 disabled:opacity-60 disabled:cursor-progress inline-flex items-center gap-2"
            >
              {creating && (
                <span
                  className="inline-block w-3 h-3 border-2 border-current border-t-transparent rounded-full animate-spin"
                  ...
                  {isRenaming ? (
                    ...
                    >
                      <div className="font-medium truncate inline-flex items-center gap-2">
                        {openingId === d.id && (
                          <span
                            className="inline-block w-3 h-3 border-2 border-muted border-t-transparent rounded-full animate-spin"
                            aria-hidden
                          />
                        )}
                        {d.title || "Untitled"}
